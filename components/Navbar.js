...
//       {/* Cart Sidebar - More Sleek */}
//       <div
//         ref={ref}
//         className={`w-80 h-[100vh] sideCart overflow-y-auto absolute top-0 right-0 bg-white shadow-2xl transform transition-transform duration-500 translate-x-full`}
//         style={{
//           scrollbarWidth: 'thin',
...
//       {/* Wishlist Sidebar - More Sleek */}
//       <div ref={wishlistRef} className={`w-80 h-[100vh] sideCart overflow-y-auto absolute top-0 right-0 bg-white shadow-2xl transform transition-transform duration-500 translate-x-full`} style={{
//         scrollbarWidth: 'thin',
//         scrollbarColor: '#fca5a5 #fef2f2'
//       }}>
//         {/* Wishlist Header - Reduced padding */}
...
//         {/* Wishlist Items - Reduced spacing */}
//         <div className='px-4 py-4'>
//           {Object.keys(wishlist).length === 0 ? (
//             <div className='flex flex-col items-center justify-center py-12'>
...
//             className="w-full px-4 py-2 pr-24 rounded-full border-2 border-slate-200 focus:border-slate-400 focus:outline-none transition-all duration-300"
//           />
//           <button
...
//       // Open cart when new items are added
//       openCart()
//     }
...
//                     if (firstItemKey) {
//                       // Navigate to the product page with the item's slug
//                       window.location.href = `/product/${firstItemKey}`;
//                     }
//                   }}
//                   className="flex-1 text-white bg-gradient-to-r from-blue-600 to-indigo-600 border-0 py-2.5 px-4 focus:outline-none hover:from-blue-700 hover:to-indigo-700 rounded-lg text-sm font-bold transition-all duration-300 shadow-md"
//                 >
//                   <BsLightningFill className="mr-2 text-sm" />
//                   Buy Now
//                 </button>
//               </div>
//               <button
...
//   // Auto-open cart when items are added (but NOT on checkout page)
//    useEffect(() => {
...
const Navbar = ({
  ...
  return (
    <div className="fixed top-0 left-0 right-0 flex flex-col justify-start md:flex-row md:justify-start lg:justify-center  lg:items-center px-4 shadow-lg text-white bg-gray-800 z-50">
      ...
      <div className="search-container hidden lg:block mt-4 lg:ml-20 lg:mt-0 mb-2 lg:mb-0 relative lg:-mr-20  flex-1  max-w-2xl lg:max-w-lg">
        <div className="relative">
          <input
            type="text"
            value={searchQuery}
      ...
      <div className="nav mx-auto  py-2 lg:block">
        <ul className="flex items-center font-alegreya-sans-medium space-x-8 font-medium md:text-lg tracking-wide">
          <Link href={"/bracelets"}>
            <span className="hover:text-slate-700 transition-all duration-300 relative group">
              <li>Bracelets</li>
